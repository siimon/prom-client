...
exports.setValue = function setValue(hashMap, value, labels) {
	...
	hashMap[hash] = {
		value: typeof value === 'number' || typeof value === 'bigint' ? value : 0,
		labels: labels || {},
	};
	return hashMap;
};
...
exports.setValueDelta = function setValueDelta(
	...
	const value =
		typeof deltaValue === 'number' || typeof deltaValue === 'bigint'
			? deltaValue
			: 0;
	if (hashMap[hash]) {
		if (typeof hashMap[hash].value === 'bigint' && typeof value !== 'bigint') {
