...
module.exports = function() {
	const residentMemGauge = new Gauge(PROCESS_RESIDENT_MEMORY, 'Resident memory size in bytes.');
	const virtualMemGauge = new Gauge(PROCESS_VIRTUAL_MEMORY, 'Virtual memory size in bytes.');
	const heapSizeMemGauge = new Gauge(PROCESS_HEAP , 'Process heap size in bytes.');
