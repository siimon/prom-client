...
module.exports = function() {
	...
	const cpuUserUsageCounter = new Counter(PROCESS_CPU_USER_SECONDS,
		'Total user CPU time spent in seconds.');
	const cpuSystemUsageCounter = new Counter(PROCESS_CPU_SYSTEM_SECONDS,
		'Total system CPU time spent in seconds.');
	const cpuUsageCounter = new Counter(PROCESS_CPU_SECONDS,
