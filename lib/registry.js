...
const registry = (function() {
	...
	Registry.prototype.getMetricAsPrometheusString = function(metric) {
		...
		const values = (item.values || []).reduce(function(valAcc, val) {
			const labels = Object.keys(val.labels || {}).map(function(key) {
...
registry.merge = function(registers) {
	...
	const metricsToMerge = registers.reduce(function(acc, reg) {
